...
export const caseStudies: CaseStudy[] = [
  {
    ...
    overview: [
      "Party Hero needed to be more than a brochure site — it's a two-sided marketplace where event suppliers list what they offer and hosts search by category, location, and event type to find them.",
